...
- [x] Create new package from Spatie skeleton
- [x] Migrate CoolifyClient
- [x] Migrate all repositories
- [x] Migrate all commands (except provision)
- [x] Migrate dashboard
- [x] Write tests

### Phase 2: Nixpacks Generation ✅

- [x] Create NixpacksGenerator class
- [x] Implement package detectors (Horizon, Reverb, Scheduler)
- [x] Create `coolify:install` command
- [x] Generate intelligent nixpacks.toml
